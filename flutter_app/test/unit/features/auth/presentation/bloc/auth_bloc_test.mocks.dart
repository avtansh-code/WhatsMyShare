...
// in whats_my_share/test/unit/features/auth/presentation/bloc/auth_bloc_test.dart.
...
class MockSignInWithEmail extends _i1.Mock implements _i4.SignInWithEmail {
  MockSignInWithEmail() {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSignUpWithEmail extends _i1.Mock implements _i8.SignUpWithEmail {
  MockSignUpWithEmail() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSignInWithGoogle extends _i1.Mock implements _i9.SignInWithGoogle {
...
class MockGetCurrentUser extends _i1.Mock implements _i11.GetCurrentUser {
  ...
  @override
  _i5.Future<_i7.UserEntity?> call() =>
      (super.noSuchMethod(
            Invocation.method(#call, []),
            returnValue: _i5.Future<_i7.UserEntity?>.value(),
          )
          as _i5.Future<_i7.UserEntity?>);
}

/// A class which mocks [ResetPassword].
///
/// See the documentation for Mockito's code generation for more information.
class MockResetPassword extends _i1.Mock implements _i12.ResetPassword {
  MockResetPassword() {
    _i1.throwOnMissingStub(this);
  }
