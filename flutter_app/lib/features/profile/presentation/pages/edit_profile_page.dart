...
/// Note: Phone number is immutable after registration (it's the user's identity)
        ...
        if (_isSaving) {
          if (state.status == ProfileStatus.photoUpdated ||
            ...
            if (state.profile != null) {
              ...
              // Only sync if photoUrl is not null
              final photoUrl = state.profile!.photoUrl;
              if (photoUrl != null) {
                context.read<AuthBloc>().add(AuthUserPhotoUpdated(photoUrl));
              }
            }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Phone number cannot be changed as it is your account identifier',
